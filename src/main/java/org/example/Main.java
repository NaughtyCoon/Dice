...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(dta.mapOfAverageScores(players));

        task("2.\tТоп-3 игроков с самым высоким средним.");
        System.out.println(dta.topThreeAveragePlayers(players));

        task("3.\t\"Неудачники\" – игроки, у которых ≥3 раза выпала 1.");
        System.out.println(dta.showTheLosers(players));

        task("4.\t\"Везунчики\" – игроки, у которых ≥4 раза выпала 6.");
        System.out.println(dta.showTheLucky(players));

        task("5.\tГруппировка игроков по фишкам (>1000, 500-1000, <500).");
        System.out.println(dta.groupPlayersByChips(players));
